...
public class cadastroTurma extends AppCompatActivity {
    ...
    public class BancoController{
        ...
        private cadastroTurma.Banco banco;
        ...
        public String insereDado(String NomeTurma, String diaAula, String horario, String chaveAcessso, String local){
            ...
            valores.put(cadastroTurma.Banco.Nome_turma, NomeTurma);
            valores.put(cadastroTurma.Banco.Data, diaAula);
            valores.put(cadastroTurma.Banco.Horario, horario);
            valores.put(cadastroTurma.Banco.Chave_Acesso, chaveAcessso);
            valores.put(cadastroTurma.Banco.Local, local);

            resultado = db.insert(cadastroTurma.Banco.Tabela_turmas, null, valores);
            db.close();
